...
public class Paciente {
    ...
    public String registrarPaciente(String cedula, String nombres, String apellidos, String edad, String genero, String fecha, String direccion, String telefonoPaciente, String tipoSangre){
        this.numeroCedula = cedula;
        this.nombres = nombres;
        this.apellidos = apellidos;
        this.edad = edad;
